 ...
 %>
										...
										<table width="91%" border="1" cellpadding="0" cellspacing="0"
											...
											<tr align="center" bgcolor="#e3F4F7">
												<td width="35%" bgcolor="#33FF99">读者类型名称</td>
												<td width="35%" bgcolor="#33FF99">可借数量</td>
											...
											<tr>
												...
												<td align="center"><a href="#"
													onClick="window.open('readerType.do?action=readerTypeModifyQuery&ID=<%=ID%>','','width=292,height=175')">修改</a></td>
												<td align="center"><a
													href="readerType.do?action=readerTypeDel&ID=<%=ID%>">删除</a></td>
											</tr>
											<%
												}
												}
