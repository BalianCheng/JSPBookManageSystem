											...
											<tr>
												...
												<td align="center" valign="top">
													<form name="form1" method="post"
														action="reader.do?action=readerModify">
														<table width="600" height="432" border="0" cellpadding="0"
															...
															<tr>
																...
																<td width="427" height="39"><input name="name"
																	type="text" value="<%=name%>" readonly="yes"> *
				...
				out.println("checked");%>>
					...
					out.println("selected");%>><%=typeName%></option>
															...
															<tr>
																...
																<td><input name="vocation" type="text"
																	id="vocation" value="<%=vocation%>"></td>
															</tr>
															<tr>
																<td align="center">出生日期：</td>
																<td><input name="birthday" type="text"
																	id="birthday" value="<%=birthday%>"></td>
															</tr>
															<tr>
				...
				out.println(" selected");%>>工作证</option>
															...
															<tr>
																...
																<td><input name="email" type="text" id="email"
																	value="<%=email%>" size="50"> <input
																	name="operator" type="hidden" id="operator"
																	value="<%=operator%>"></td>
															</tr>
															<tr>
																<td height="30" align="center">操&nbsp;作&nbsp;员：</td>
																<td><input name="operator" type="text"
																	id="operator" value="<%=operator%>" readonly="yes">
																</td>
															</tr>
															<tr>
															...
															<tr>
																...
																<td><input name="Submit" type="submit"
																	class="loginbutton" value="保存"
																	onClick="return check(form1)"> &nbsp; <input
																	name="Submit2" type="button" class="loginbutton"
