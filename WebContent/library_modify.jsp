											...
											<table width="58%" border="0" cellpadding="0" cellspacing="0"
												...
												<tr align="center">
													...
													<td width="80%" align="left"><input name="libraryname"
														type="text" id="libraryname" value="<%=libraryname%>"
														size="30"></td>
												<tr>
												...
												<tr>
													...
													<td><input name="Submit" type="submit"
														...
														onClick="return checkForm(form1)"> &nbsp; <input
														name="Submit2" type="reset" class="loginbutton" value="取消"></td>
												</tr>
											</table>
										</form>
									</td>
