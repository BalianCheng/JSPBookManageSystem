						...
						<td><table width="100%" height="131" border="0"
								...
								<tr>
									<td align="center" valign="top"><form name="form1"
											method="post" action="bookCase.do?action=bookCaseAdd">
											<table width="100%" height="114" border="0" cellpadding="0"
												cellspacing="0">
												<tr>
													<td height="74" align="center">书架名称： <input
														name="name" type="text"></td>
												</tr>
												<tr>
													<td align="center"><input name="Submit3" type="submit"
														class="btn_grey" value="保存"> &nbsp; <input
														name="Submit22" type="button" class="btn_grey" value="关闭"
