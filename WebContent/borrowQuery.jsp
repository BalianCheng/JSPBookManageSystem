	...
	function check(myform) {
		...
		if (myform.flag[1].checked) {
			...
			if (CheckDate(myform.edate.value)) {
				alert("您输入的结束日期不正确（如：2016-06-01）\n 请注意闰年!");
				myform.edate.focus();
				return false;
			}
		}
...
<body onLoad="clockon(bgclock)">
	...
	<table width="778" border="0" cellspacing="0" cellpadding="0"
		align="center">
		<tr>
			<td valign="top" bgcolor="#FFFFFF"><table width="99%"
					height="510" border="0" align="center" cellpadding="0"
					cellspacing="0" bgcolor="#FFFFFF" class="tableBorder_gray">
					<tr>
						<td height="510" valign="top" style="padding:5px;"><table
								width="98%" height="487" border="0" cellpadding="0"
								cellspacing="0">
								<tr>
									<td height="22" valign="top" class="word_blue">当前位置：系统查询
										&gt; 图书借阅查询 &gt;&gt;&gt;</td>
								</tr>
								<tr>
									<td align="center" valign="top">
										<form name="myform" method="post"
											...
											<table width="98%" height="67" border="0" cellpadding="0"
												...
												<tr>
													<td rowspan="2" align="center" bgcolor="#33FF99">&nbsp;<img
														src="Images/search.png" width="45" height="28"
														style="height: 32px; width: 29px;"></td>
													<td height="29" bgcolor="#33FF99"><input name="flag"
													...
													</select> <input name="key" type="text" id="key" size="50">
														<input name="Submit" type="submit" class="btn_grey"
														value="查询" onClick="return check(myform)"></td>
												</tr>
												<tr>
													<td height="26" bgcolor="#33FF99"><input name="flag"
														type="checkbox" class="noborder" value="b"> 借阅时间：
														从 <input name="sdate" type="text" id="sdate"> 到 <input
 ...
 %>
										<table width="98%" border="1" cellpadding="0" cellspacing="0"
											...
											<tr align="center" bgcolor="#e3F4F7">
												<td width="11%" bgcolor="#33FF99">图书条形码</td>
												<td width="29%" bgcolor="#33FF99">图书名称</td>
												<td width="15%" bgcolor="#33FF99">读者条形码</td>
												<td width="13%" bgcolor="#33FF99">读者名称</td>
												<td width="12%" bgcolor="#33FF99">借阅时间</td>
												<td width="12%" bgcolor="#33FF99">应还时间</td>
												<td width="8%" bgcolor="#33FF99">是否归还</td>
											</tr>
											<%
												while (it.hasNext()) {
