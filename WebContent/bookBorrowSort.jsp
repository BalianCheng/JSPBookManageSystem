			...
			<td valign="top" bgcolor="#FFFFFF"><table width="99%"
					...
					<tr>
						<td height="510" valign="top" style="padding:5px;"><table
								...
								cellspacing="0">
								<tr>
									<td height="22" valign="top" class="word_blue">当前位置：图书借阅排行榜
										&gt;&gt;&gt;</td>
								</tr>
								<tr>
 ...
 %>
										<table width="98%" border="1" cellpadding="0" cellspacing="0"
											...
											<tr align="center" bgcolor="#e3F4F7">
												<td width="8%" bgcolor="#33FF99">借阅次数</td>
												<td width="11%" bgcolor="#33FF99">图书条形码</td>
												<td width="17%" bgcolor="#33FF99">图书名称</td>
												<td width="15%" bgcolor="#33FF99">图书类型</td>
												<td width="16%" bgcolor="#33FF99">书架</td>
												<td width="14%" bgcolor="#33FF99">出版社</td>
												<td width="11%" bgcolor="#33FF99">作者</td>
												<td colspan="2" bgcolor="#33FF99">定价(元)</td>
											</tr>
											<%
												while (it.hasNext()) {
