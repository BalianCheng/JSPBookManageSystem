			...
			<td valign="top" bgcolor="#FFFFFF"><table width="99%"
					...
					<tr>
						<td height="510" valign="top" style="padding:5px;"><table
								width="98%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td height="22" valign="top" class="word_blue">当前位置：图书管理
										&gt; 图书档案管理 &gt;&gt;&gt;</td>
								</tr>
								<tr>
									<td align="center" valign="top">
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td><a href="book_add.jsp">添加图书信息</a></td>
											</tr>
										</table> <%
 	} else {
 		//通过迭代方式显示数据
 ...
 %>
										...
										<table width="98%" border="1" cellpadding="0" cellspacing="0"
											...
											<tr align="center" bgcolor="#e3F4F7">
												...
												<td width="26%" bgcolor="#33FF99">图书名称</td>
												<td width="15%" bgcolor="#33FF99">图书类型</td>
												<td width="14%" bgcolor="#33FF99">出版社</td>
												<td width="12%" bgcolor="#33FF99">书架</td>
												<td width="9%" bgcolor="#33FF99">修改</td>
											...
											<tr>
												...
												<td align="center"><a
													href="book.do?action=bookDel&ID=<%=ID%>">删除</a></td>
											</tr>
											<%
												}
												}
