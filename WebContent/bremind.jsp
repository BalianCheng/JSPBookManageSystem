 ...
 %>
										<table width="98%" border="1" cellpadding="0" cellspacing="0"
											...
											<tr align="center" bgcolor="#e3F4F7">
												<td width="15%" bgcolor="#33FF99">图书条形码</td>
												<td width="28%" bgcolor="#33FF99">图书名称</td>
												<td width="17%" bgcolor="#33FF99">读者条形码</td>
												<td width="9%" bgcolor="#33FF99">读者名称</td>
												<td width="15%" bgcolor="#33FF99">借阅时间</td>
												<td width="16%" bgcolor="#33FF99">应还时间</td>
											</tr>
											<%
												while (it.hasNext()) {
