...
<body onLoad="clockon(bgclock)">
			...
			<td valign="top" bgcolor="#FFFFFF"><table width="99%"
					...
					<tr>
						<td height="510" valign="top" style="padding:5px;"><table
								...
								cellspacing="0">
								<tr>
									<td height="22" valign="top" class="word_blue">当前位置：读者管理
										&gt; 读者档案管理 &gt;&gt;&gt;</td>
								</tr>
								<tr>
									<td align="center" valign="top">
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td><a href="reader_add.jsp">添加读者信息</a></td>
											</tr>
										</table> <%
 	} else {
 		//通过迭代方式显示数据
 ...
 %>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="87%">&nbsp;</td>
												<td width="13%"><a href="reader_add.jsp">添加读者信息</a></td>
											</tr>
										</table>
										<table width="95%" border="1" cellpadding="0" cellspacing="0"
											...
											<tr align="center" bgcolor="#e3F4F7">
												<td width="13%" bgcolor="#33FF99">条形码</td>
												<td width="10%" bgcolor="#33FF99">姓名</td>
												<td width="8%" bgcolor="#33FF99">读者类型</td>
												<td width="12%" bgcolor="#33FF99">证件类型</td>
												<td width="20%" bgcolor="#33FF99">证件号码</td>
												<td width="12%" bgcolor="#33FF99">电话</td>
												<td width="15%" bgcolor="#33FF99">Email</td>
												<td width="5%" bgcolor="#33FF99">修改</td>
												<td width="5%" bgcolor="#33FF99">删除</td>
											</tr>
											<%
												while (it.hasNext()) {
											...
											<tr>
												...
												<td style="padding:5px;"><a
													href="reader.do?action=readerDetail&ID=<%=ID%>"><%=name%></a></td>
