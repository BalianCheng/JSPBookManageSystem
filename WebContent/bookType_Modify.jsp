						...
						<td><table width="100%" height="131" border="0"
								...
								<tr>
									<td align="center" valign="top"><form name="form1"
											method="post" action="bookType.do?action=bookTypeModify">
											<input name="id" type="hidden" size="50"
												value="<%=bookTypeForm.getId()%>">
											<table width="100%" height="111" border="0" cellpadding="0"
												cellspacing="0">
												<tr>
													<td width="29%" align="center">类型名称：</td>
													<td width="71%"><input name="typeName" type="text"
														size="30" value="<%=bookTypeForm.getTypeName()%>">
													</td>
												</tr>
												<tr>
													<td align="center">可借天数：</td>
													<td><input name="days" type="text" size="25"
