			...
			<td valign="top" bgcolor="#FFFFFF"><table width="100%"
					...
					<tr>
						<td height="27" valign="top" style="padding:5px;"
							class="word_blue">当前位置：图书借还 &gt; 图书借阅 &gt;&gt;&gt;</td>
					</tr>
					<tr>
								...
								<form name="form1" method="post"
									...
									<tr>
										<td height="72" align="center" valign="top"
											background="Images/main_booksort_1.gif" bgcolor="#66CC00"><table
												width="96%" border="0" cellpadding="1" cellspacing="0"
												bordercolor="#FFFFFF" bgcolor="#66CC00">
												<tr>
												...
												<tr>
													<td height="32">&nbsp;添加的依据： <input name="f"
														type="radio" class="noborder" value="barcode" checked>
														图书条形码 &nbsp;&nbsp; <input name="f" type="radio"
														class="noborder" value="bookname">
														图书名称&nbsp;&nbsp; <input name="inputkey" type="text"
														id="inputkey" size="50"> <input name="Submit2"
														type="button" class="btn_grey" value="确定"
														onClick="checkbook(form1)"> <input name="operator"
														type="hidden" id="operator" value="<%=manager%>">
												...
												<tr>
													<td valign="top" bgcolor="#66CC00" style="padding:5px"><table
															...
															%>
															<input name="borrowNumber" type="hidden"
																id="borrowNumber" value="<%=borrowNumber%>">
														</table></td>
												</tr>
