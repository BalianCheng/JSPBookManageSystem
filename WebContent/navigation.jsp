...
<%
	...
	ManagerForm form1 = (ManagerForm) managerDAO
			.query_p((String) session.getAttribute("manager"));
	int sysset1 = 0;
	int readerset1 = 0;
	int bookset1 = 0;
	int borrowback1 = 0;
...
<table width="1011" border="0" align="center" cellpadding="0"
	...
	<tr bgcolor="#33CC00">
		...
		<td width="66%" align="right" bgcolor="#66FF99" class="word_white"><a
 ...
 %><a onmouseover=showmenu(event,querymenu) onmouseout=delayhidemenu()
			class="word_white" style="CURSOR:hand">系统查询</a> | <%
 	}
 %><a href="manager.do?action=querypwd" class="word_white">更改密码</a> |
			<a href="#" onClick="quit()" class="word_white">退出系统</a></td>
		<td width="2%" bgcolor="#66FF99">&nbsp;</td>
	</tr>
	<tr bgcolor="#DFA40C">
	</tr>
</table>
