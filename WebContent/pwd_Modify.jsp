			...
			<td valign="top" bgcolor="#FFFFFF"><table width="99%"
					...
					<tr>
						<td height="510" valign="top" style="padding:5px;"><table
								...
								cellspacing="0">
								<tr>
									<td height="22" valign="top" class="word_blue">当前位置：更改口令
										&gt;&gt;&gt;</td>
								</tr>
								<tr>
									<td align="center" valign="top">
										...
										<form name="form1" method="post"
											action="manager.do?action=modifypwd">
											<table width="47%" border="0" cellpadding="0" cellspacing="0"
												...
												<tr align="center">
													...
													<td width="73%" align="left"><input name="name"
														type="text" id="name" value="<%=managerForm.getName()%>"
