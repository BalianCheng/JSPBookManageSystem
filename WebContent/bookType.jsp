...
<body onLoad="clockon(bgclock)">
 ...
 %>
										<table width="91%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="82%">&nbsp;</td>
												<td width="18%" align="right"><a href="#"
													onClick="window.open('bookType_add.jsp','','width=292,height=175')">添加图书类型信息</a>
												</td>
											</tr>
										</table>
										<table width="91%" border="1" cellpadding="0" cellspacing="0"
											...
											<tr align="center" bgcolor="#e3F4F7">
												<td width="35%" bgcolor="#33FF99">图书类型名称</td>
												<td width="35%" bgcolor="#33FF99">可借天数</td>
												<td width="16%" bgcolor="#33FF99">修改</td>
												<td width="14%" bgcolor="#33FF99">删除</td>
											</tr>
											<%
												while (it.hasNext()) {
											...
											<tr>
												...
												<td align="center"><a href="#"
													onClick="window.open('bookType.do?action=bookTypeModifyQuery&ID=<%=ID%>','','width=292,height=175')">修改</a></td>
												<td align="center"><a
													href="bookType.do?action=bookTypeDel&ID=<%=ID%>">删除</a></td>
											</tr>
											<%
												}
												}
