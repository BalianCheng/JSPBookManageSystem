									...
									<td align="center" valign="top">
										<form action="" method="post" name="form1">
											<table width="98%" height="38" border="0" cellpadding="0"
												...
												<tr>
													<td align="center" bgcolor="#66CC00">&nbsp;<img
														src="Images/search.png" width="45" height="28"
														style="height: 28px; width: 27px; "></td>
													<td bgcolor="#66CC00">请选择查询依据： <select name="f"
											...
											<table width="98%" border="1" cellpadding="0" cellspacing="0"
												...
												<tr align="center" bgcolor="#e3F4F7">
													<td width="17%" bgcolor="#33FF99">条形码</td>
													<td width="31%" bgcolor="#33FF99">图书名称</td>
													<td width="18%" bgcolor="#33FF99">图书类型</td>
													<td width="19%" bgcolor="#33FF99">出版社</td>
													<td width="15%" bgcolor="#33FF99">书架</td>
												</tr>
												<%
													while (it.hasNext()) {
												...
												<tr>
													...
													<td style="padding:5px;"><a
														href="book.do?action=bookDetail&ID=<%=ID%>"><%=bookname%></a></td>
