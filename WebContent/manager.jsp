			...
			<td valign="top" bgcolor="#FFFFFF"><table width="99%"
					...
					<tr>
						<td height="510" valign="top" style="padding:5px;"><table
								...
								cellspacing="0">
								<tr>
									<td height="22" valign="top" class="word_blue">当前位置：系统设置
										&gt; 管理员设置 &gt;&gt;&gt;</td>
								</tr>
								<tr>
 ...
 %>
										...
										<table width="91%" border="1" cellpadding="0" cellspacing="0"
											...
											<tr align="center" bgcolor="#e3F4F7">
												<td width="26%" bgcolor="#33FF99">管理员名称</td>
												<td width="12%" bgcolor="#33FF99">系统设置</td>
												<td width="12%" bgcolor="#33FF99">读者管理</td>
												<td width="12%" bgcolor="#33FF99">图书管理</td>
												<td width="11%" bgcolor="#33FF99">图书借还</td>
												<td width="10%" bgcolor="#33FF99">系统查询</td>
												<td width="9%" bgcolor="#33FF99">权限设置</td>
												<td width="8%" bgcolor="#33FF99">删除</td>
											</tr>
											<%
												while (it.hasNext()) {
											...
											<tr>
												...
												<td align="center"><input name="checkbox"
													type="checkbox" class="noborder" value="checkbox"
													disabled="disabled"
													<%if (sysset == 1) {
						out.println("checked");
					}%>></td>
						...
						out.println("checked");
												...
												<td align="center"><input name="checkbox"
													type="checkbox" class="noborder" value="checkbox" disabled
													<%if (bookset == 1) {
						out.println("checked");
					}%>></td>
												<td align="center"><input name="checkbox"
						...
						out.println("checked");
												...
												<td align="center">
													<%
														if (!name.equals("tsoft")) {
													%><a
													href="manager.do?action=managerDel&id=<%=ID%>">删除</a>
													<%
														} else {
													%>&nbsp;<%
														}
