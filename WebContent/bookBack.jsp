			...
			<td valign="top" bgcolor="#FFFFFF"><table width="100%"
					...
					<tr>
						<td align="center" valign="top" style="padding:5px;"><table
								...
								<tr>
									<td height="72" align="center" valign="top" bgcolor="#66CC00"><table
												...
												<td valign="top" bgcolor="#66CC00">
													...
													<table width="100%" border="0" cellpadding="0"
														...
														<form name="form1" method="post"
															action="borrow.do?action=bookback">
																...
																<td><table width="90%" height="21" border="0"
																		...
																		<tr>
																			<td width="24%" height="18"
																				style="padding-left:7px;padding-top:7px;">读者验证</td>
											...
											<tr>
												<td valign="top"><table width="100%" height="35"
														...
														bordercolordark="#66CC00" bgcolor="#FFFFFF">
														<tr align="center" bgcolor="#e3F4F7">
															<td width="24%" height="25" bgcolor="#33FF99">图书名称</td>
															<td width="12%" bgcolor="#33FF99">借阅时间</td>
															<td width="13%" bgcolor="#33FF99">应还时间</td>
															<td width="14%" bgcolor="#33FF99">出版社</td>
															<td width="12%" bgcolor="#33FF99">书架</td>
															<td bgcolor="#33FF99">定价(元)</td>
															<td width="12%" bgcolor="#33FF99"><input
																name="Button22" type="button" class="btn_grey"
																value="完成归还"
														...
														<tr>
															...
															<td width="12%" align="center"><a
																href="borrow.do?action=bookback&barcode=<%=barcode%>&id=<%=id%>&operator=<%=manager%>">归还</a>&nbsp;</td>
														</tr>
														<%
															}
															}
