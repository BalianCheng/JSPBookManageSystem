					...
					<td valign="top"><table width="100%" height="525" border="0"
							...
							<tr>
								<td height="800" align="center" valign="top"><table
										...
										cellspacing="0">
										<tr>
											<td height="271" align="right" valign="top" class="word_blue"><table
													width="100%" height="768" border="0" cellpadding="0"
																			...
																			<table width="100%" border="0" cellpadding="0"
																				...
																				<tr>
																					...
																					<td width="31%"><input name="name" type="text"
																						class="logininput" id="name" size="33"></td>
																					<td width="9%">&nbsp;</td>
																				</tr>
																				<tr>
																					<td height="37">&nbsp;</td>
																					...
																					<td><input name="pwd" type="password"
																						class="logininput" id="pwd" size="33"></td>
																					<td>&nbsp;</td>
																				</tr>
																				<tr>
																					<td height="30">&nbsp;</td>
																					<td colspan="2" align="center"><input
																						name="Submit" type="submit" class="loginbutton"
																						value="确定" onClick="return check(form1)">
																						&nbsp; <input name="Submit3" type="reset"
																						class="loginbutton" value="重置">&nbsp; <input
