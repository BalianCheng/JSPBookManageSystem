...
public class ReaderType extends Action {
	...
	/*********************** 查询全部读者类型信息 **************************/
	private ActionForward readerTypeQuery(ActionMapping mapping,
	...
	/*********************** 查询修改读者类型信息 **************************/
	private ActionForward readerTypeModifyQuery(ActionMapping mapping,
			ActionForm form, HttpServletRequest request,
			HttpServletResponse response) {
	...
	/*********************** 修改读者类型信息 **************************/
	private ActionForward readerTypeModify(ActionMapping mapping,
			ActionForm form, HttpServletRequest request,
			HttpServletResponse response) {
